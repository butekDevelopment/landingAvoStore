                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 wow fadeInRight">
                        ...
                        <div class="row">
                            ...
                            <div class="col btn-group btn-group-toggle">
                                <p class="text-left">{{ $item->stock }} pcs - <p style="font-size: 14px">&nbsp Contact AvoStore for detail stok</p></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-5 btn-group btn-group-toggle">
                        ...
                        <div class="py-2 px-3" style="border-radius: 10px; background-color: #24ad4d">
                            ...
                            <h2 class="mb-0 text-right" style="color: white; font-weight: bold">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col text-right align-self-center">
                                <ul class="social-icons">
                                    <li><a href="https://api.whatsapp.com/send?phone=6281334888859&text=_Halo%20AvoStore%20Malang_%0ATanya%20product%20*{{ $item->name_product }}*%0A%20%0A%20%0A" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
                                    <li><a href="https://www.instagram.com/avostore.malang/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                    <li><a href="https://shopee.co.id/avostore.malang" target="_blank"><i class="fas fa-shopping-bag"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
